 ...
 */
package actividaddeclases;
import java.util.Scanner;
/**
 *
 * @author Karol Cobos
 */
public class ActividaddeClases {
  ...
  Scanner leer = new Scanner(System.in);
        ...
        actividades.setNombre("Jorge Dzul");
        actividades.setEdad(18);
        actividades.setSexo('M');
        actividades.setCurp("DUCJ021028HCCZBRA2");
        actividades.setActividad("Realizacion de mantenimiento");
